...
//      primary mechanism.
//   3. inserting a contribution in app/api/contribute — alumni_profiles
//      has no select policy AND (0004_tighten_alumni_grants.sql) no
//      table grants at all for anon/authenticated, on purpose: the raw
//      table is never client-readable or client-writable, by design,
//      even for a signed-in student inserting their OWN row. This is the
//      one sanctioned bypass, and it exists specifically so
//      verified/source can be forced server-side (see
//      lib/contribute/submission.js#mapContributionToRow) with no RLS
//      policy an attacker could race or misconfigure.

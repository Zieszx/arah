...
const en = {
  ...
  explore: {
    ...
    detail: {
      ...
      satisfactionIntro:
        'How students in this field rated their own satisfaction, 1 to 5.',
      satisfactionAxisLabel: 'students',
      preuKicker: 'pre-university routes',
      preuIntro: 'The pre-U programmes students in this field took before choosing it.',
      streamsKicker: 'SPM streams',
      streamsIntro: 'The SPM streams students in this field came from.',
      quotesKicker: 'advice',

...
const en = {
  ...
  admin: {
    ...
    users: {
      ...
      passwordNotice:
        'Passwords are stored hashed and cannot be shown here, or anywhere else — not even to an admin. If someone cannot get in, they reset their own password; nobody resets it for them.',

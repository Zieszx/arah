...
//   /contribute           cold 0.36s   warm 0.39s
//
// The explore pages stayed slow when warm because they re-ran their queries
// on every single request; /contribute, which queries nothing, did not.
//
// Invalidation is belt and braces. `revalidate` caps staleness at five
// minutes on its own, and approving or rejecting a contribution calls
// revalidateTag(PUBLIC_STATS_TAG) so a moderator sees their decision
// reflected immediately rather than waiting out the window. The underlying
